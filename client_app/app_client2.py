...
def post_registrer():
    ...
    callback_uri = 'http://localhost:8007/callback_teste'  # URL do callback para receber notificações
...
def callback():
    ...
    with open('60_minutos_plmn_1000_users_1_2_segundos_dataset_2.json', 'w') as file:
