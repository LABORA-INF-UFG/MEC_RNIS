...
def post_registrer():
    api_url = 'http://127.0.0.1:5000/app_3/rni/v2'
    endpoint = '/subscriptions'
    preferences = ['notification_type_1', 'notification_type_2']
    callback_uri = 'http://localhost:8003/callback_app_3'
...
@app.route('/callback_app_3', methods=['POST'])
def callback():
    ...
    caminho_arquivo = os.path.join(args.directory, f"tempos_decorridos_plmn_app3_client_{n}.txt")
