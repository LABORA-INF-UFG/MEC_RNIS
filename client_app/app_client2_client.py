...
def post_registrer():
    api_url = 'http://127.0.0.1:5000/cliente_2/rni/v2'  # Substitua pela URL da sua API
    ...
    callback_uri = 'http://localhost:8007/callback2'  # URL do callback para receber notificações

    data = {
        'NotificationSubscription': "plmn",
        'callback_uri': "http://localhost:8007/callback2"
    }
...
def callback():
    ...
    caminho_arquivo = "/l/disk0/mcunha/Documentos/ufg/MEC_RNIS/locust/05_minutos_client_200users_1_2s_4_mec_apps/tempos_decorridos_plmn_2_client_1.txt"
