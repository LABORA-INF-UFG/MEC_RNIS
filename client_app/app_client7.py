...
def post_registrer():
    ...
    callback_uri = 'http://localhost:8001/callback_app_7'  # URL do callback para receber notificações

    data = {
        'NotificationSubscription': "rab",
        'callback_uri': "http://localhost:8001/callback_app_7"
    }
...
@app.route('/callback_app_7', methods=['POST'])
def callback():
    ...
    with open('10_minutos_rab_1000_users_1_2_segundos_dataset_7.json', 'w') as file:
