...
def post_registrer():
    api_url = 'http://127.0.0.1:5000/app_4/rni/v2'
    endpoint = '/subscriptions'
    preferences = ['notification_type_1', 'notification_type_2']
    callback_uri = 'http://localhost:8004/callback_app_4'
...
def callback():
    ...
    caminho_arquivo = os.path.join(args.directory, f"tempos_decorridos_rab_app4_client_{n}.txt")
