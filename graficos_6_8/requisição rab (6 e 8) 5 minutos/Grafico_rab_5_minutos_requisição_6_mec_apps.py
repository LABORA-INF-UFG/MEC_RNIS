...
quantidade_requisicoes_atendidas = [12641.4, 11841.4, 10247.9, 8694.6, 9269.5, 7844.9, 7603.2, 7997.4]
quantidade_informacoes_nao_atendidas = [0, 0, 1405.2, 9459.2, 11019.7, 18216.1, 44730.1, 44158.9]
...
ax.set_title('Quantidade de requisições rab atendidas e não')
...
quantidade_requisicoes_atendidas_2 = [7065.5, 6955.1, 6060.2, 5411.8, 5595, 4478.1, 4488.4, 4427.1]
quantidade_informacoes_nao_atendidas_2 = [0, 0, 176.9, 5778.6, 7481.3, 11437.1, 29523, 28200.9]
...
ax2.set_title('Quantidade de requisições rab atendidas e não')
...
new_img.save('combined_graphs_rab_6_mec_apps.png')
