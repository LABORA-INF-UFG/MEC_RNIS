...
quantidade_requisicoes_atendidas = [12009.7, 11378.4, 9953.3, 8422.9, 8798.3, 7329.2, 7477.3, 7578.9]
quantidade_informacoes_nao_atendidas = [0, 0, 1220, 9157.6, 10278.4, 15064.9, 43011.3, 41868.4]
...
quantidade_requisicoes_atendidas_2 = [7217.6, 6546.3, 5923.3, 5052.9, 5052.3, 4091, 4005.2, 4114.3]
quantidade_informacoes_nao_atendidas_2 = [0, 0, 199.4, 6257.2, 7018, 10584.2, 28639.7, 27077.7]
...
ax2.text(0.5, 1.1, '8 MEC Apps', ha='center', va='center', fontsize=12, transform=ax2.transAxes)
