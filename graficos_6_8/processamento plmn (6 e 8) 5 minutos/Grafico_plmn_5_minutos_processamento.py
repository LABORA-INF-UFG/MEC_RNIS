...
img1 = Image.open("combined_graphs_plmn_6_mec_apps.png")
img2 = Image.open("combined_graphs_plmn_8_mec_apps.png")
...
new_img.save('Grafico_plmn_5_minutos_processamento_6_8_mec_apps.png')
