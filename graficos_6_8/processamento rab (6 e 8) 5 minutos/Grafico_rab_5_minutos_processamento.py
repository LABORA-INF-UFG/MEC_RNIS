...
img1 = Image.open("combined_graphs_rab_6_mec_apps.png")
img2 = Image.open("combined_graphs_rab_8_mec_apps.png")
...
new_img.save('Grafico_rab_5_minutos_processamento_6_8_mec_apps.png')
