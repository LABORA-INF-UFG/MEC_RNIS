...
processamento_interno = [12.373, 14.108, 10.560, 12.749, 7.546, 8.256, 8.857, 8.675]
processamento_ate_o_cliente = [17.634, 19.365, 15.627, 18.960, 11.950, 12.799, 13.798, 13.556]
...
ax.set_title('Média de tempo de processamento RAB')
...
processamento_interno_2 = [35.421, 36.098, 34.505, 17.676, 17.492, 20.160, 20.995, 21.842]
processamento_ate_o_cliente_2 = [48.110, 49.287, 48.661, 28.253, 27.116, 30.812, 32.373, 33.319]
...
ax2.set_title('Média de tempo de processamento RAB')
