...
from v2.models.filter_criteria_assoc_ho import FilterCriteriaAssocHo  # noqa: F401,E501
...
class CellChangeSubscription(Model):
    ...
    """
    def __init__(self, subscription_type: str=None, links: Links=None, callback_reference: str=None, websock_notif_config: WebsockNotifConfig=None, expiry_deadline: TimeStamp=None, filter_criteria_assoc_ho: FilterCriteriaAssocHo=None, request_test_notification: bool=None):  # noqa: E501
