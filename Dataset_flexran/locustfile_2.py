...
class MyLocustUser(HttpUser):
    ...
    with open('/l/disk0/mcunha/Documentos/ufg/MEC_RNIS/Dataset_flexran/radio_network_data_plmn.json', 'r') as file:
        data_list_plmn = json.load(file)


    # Abra o arquivo JSON e leia os dados
    with open('/l/disk0/mcunha/Documentos/ufg/MEC_RNIS/Dataset_flexran/radio_network_data_rab.json', 'r') as file:
